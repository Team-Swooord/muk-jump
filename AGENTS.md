...
- 사용자 요청(2026-09-10, 2026-09-11 재확인): 정식 출시 전 TestFlight 업로드 때마다
  먹점프 뒤끝 프로젝트의 게임 계정 전인원과 해당 게임 정보·리더보드를 영구 삭제한다.
  특정 테스터나 연동 계정을 예외로 남기지 않는다. 매회 실제 프로젝트·대상 계정 수를 읽기 전용으로
