...
| 구성 | 생존 13·도약 19·먹 운용 13, 총 45개 열매 | 내구·점프·먹·발판·아이템 운을 바꾸는 8종 |
...
도약 계보는 공용 뿌리 뒤 `준비시간 / 점프 힘 / 점프 높이` 세 길이 각각 5단계로 이어집니다. 끝에서는 벽 매달림 점프, 5회마다 생기는 단방향 안전 발판, 자동 2단점프 중 하나를 장착합니다. 세 길은 먹청록·쪽빛·옅은 자주먹으로만 살짝 구분해 수묵화 분위기와 가독성을 함께 유지합니다.
