...
> 첫 시작에서는 실제 플레이 위의 5단계 안내가 한 획 그리기와 발판 착지를 먼저
> 익히게 합니다. 장애물·바람·맵 안내까지 끝낸 뒤에는 옵션에서 언제든 다시 볼 수 있습니다.
...
- 하단 붓획 게이지는 그리는 중인 획까지 포함한 잔량 비율을 실시간으로 보여 주며,
  성장과 붓 여유로 최대치가 늘면 숫자 없이 트랙 폭도 함께 길어집니다.
...
- 각 먹방울은 기본 내구 3칸을 가지며, 자기 머리 위에 서로 떨어진 3개 체력 칸으로
  따로 표시됩니다.
...
- 화면 아래로 떨어진 먹방울은 방어막이 없으면 체력 1칸을 잃고 화면 안으로
  튀어오릅니다. 마지막 체력까지 소진된 개체만 사망하며, 살아 있는 먹방울이
