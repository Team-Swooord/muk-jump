...
현재 고도가 도전 시작 시점의 최고 기록을 처음 넘어서는 순간, 상단 최고 기록 HUD가
`신기록`으로 바뀌고 붉은 낙관 형태의 `지금 기록이 최고` 표시가 해당 플레이가 끝날 때까지
유지된다. 풍향은 보통 28~45초 동안 같은 방향을 유지한 뒤 먹선이 흐르듯 천천히 전환하며,
강풍 예고·상승기류·회복 중에는 방향 유지 시간이 흐르지 않는다.
