...
- 본체는 기본 내구 1칸으로 시작하고, 영구 성장의 먹피 경로를 열면
  2→3→4→5칸까지 늘어납니다. 모든 분신은 성장과 관계없이 항상 1/1 체력이며,
  각 먹방울 머리 위에 자기 최대치만큼 분리된 체력 칸으로 표시됩니다.
...
- 생존: `본체 최대 체력 +1×4 / 피격 뒤 무적 +0.04초×4 → 본체 1회 방어막 / 피격 수평 밀림 -6%×3 → 먹떼 결실 +1`
- 도약: `준비시간 -1.5%×4 / 점프 힘 +1%×5 / 점프 높이 +1.5625%×4`
- 먹 운용: `최대 먹 용량 +37.5%×4 / 획당 먹 소모 -2%×5 / 게이지 회복 +10%×4`

완성하면 본체 체력은 1→5칸, 분신 체력은 항상 1칸이며 피격 뒤 무적은 +0.16초가 됩니다.
...
- 24마리 먹떼의 최고 생존자 카메라, 하위 중앙 진행 기준, 본체 성장 체력·분신 1칸, VFX 예산 관리
