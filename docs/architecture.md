...
최대 먹 용량 확장 아이템은 사용하지 않는다. 먹 운용의 갈래별 상한은 최대 먹 용량
+150%(4.8→12.0m)·선명 +1초, 획당 먹 소모 -10%·짧은 획 추가 -15%, 게이지 회복
+40%·마름 시작 -0.8초다. 도약 갈래별 상한은 자동 점프 준비 -6%·그린 먹선 준비
추가 -25%, 기본 점프 힘 +5%·그린 먹선 +10%, 점프 정점 높이 +6.25%·하단 낙하
50% 완화/14초다. 생존 갈래별 상한은 본체 체력 5칸·분신 체력 2칸, 피격 무적
+0.16초·본체 체력 +1·장애물 피격 생존 방어막, 수평 속도 보존율 64%·먹분신
아이템 1회 최대 2마리다. 같은 계보의 세 상한은 동시에 적용하지 않는다.
